...
public class __aes_file_Encryption {
      ...
      public static void main(final String[] args) throws Exception {
            ...
            // Encrypted File:
            FileOutputStream __outFile = new FileOutputStream("output/file/encrypted/encryptedFile.des");
            ...
            FileOutputStream __saltOutput = new FileOutputStream("output/file/encrypted/salt.enc");
             ...
             *          `iv`.
             */
            FileOutputStream __iv_output = new FileOutputStream("output/file/encrypted/iv_output.enc");
